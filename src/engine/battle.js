...
export const BattleSystem = {
     ...
     * 玩家行动：使用道具
     */
    // 玩家使用物品（已拆分到battle-player-item.js）
    playerUseItem(itemId) {
        return playerUseItemImpl.call(this, itemId);
    },
     ...
     */
    // 敌人战术AI（已拆分到battle-ai-tactical.js）
    enemyAITactical() {
        return enemyAITacticalImpl.call(this);
    },
