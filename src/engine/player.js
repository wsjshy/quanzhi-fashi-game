...
export const SAVE_VERSION = '0.8.7';

// 技能解锁表：按元素和等级定义可解锁的技能
export const SKILL_UNLOCK_TABLE = {
    fire: {
        1: ['fire_bolt'],
        3: ['fire_rain'],
        5: ['fire_burst']
...
if (typeof window !== 'undefined') window.SAVE_VERSION = SAVE_VERSION;
if (typeof window !== 'undefined') window.SKILL_UNLOCK_TABLE = SKILL_UNLOCK_TABLE;
