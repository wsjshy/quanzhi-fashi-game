...
import { renderCharacterCreate as renderCharacterCreateImpl } from './ui-character-create.js';
import { showPrimarySecondarySelection as showPrimarySecondarySelectionImpl } from './ui-primary-secondary.js';
import { showDailySummary as showDailySummaryImpl } from './ui-daily-summary.js';
...
export const UI = {
    ...
    // v0.9.4: 显示每日总结
    // 显示每日总结（已拆分到ui-daily-summary.js）
    showDailySummary(stats) {
        return showDailySummaryImpl.call(this, stats);
    },
    ...
    // ========== 角色创建界面 ==========
    // 渲染角色创建界面（已拆分到ui-character-create.js）
    renderCharacterCreate() {
        return renderCharacterCreateImpl.call(this);
    },
     ...
     */
    // 显示主副系选择界面（已拆分到ui-primary-secondary.js）
    showPrimarySecondarySelection(elements, callback, isFirstTime = false) {
        return showPrimarySecondarySelectionImpl.call(this, elements, callback, isFirstTime);
    },
