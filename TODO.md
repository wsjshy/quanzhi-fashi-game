...
- [ ] 审查唐月对话树，追加：神秘电话暗示（高信任+晚上触发）
- [ ] 审查张小侯对话树深度，追加：日常对话/小道消息/忠诚事件
- [ ] 审查穆宁雪对话树，追加：家族压力暗示/冰系天赋伏笔
- [ ] 穆白对话树（缺失，需新建——博城篇重要对手）
- [ ] 罗宋对话树（缺失，需新建——雪峰山冲突）
- [ ] 追加隐藏对话：唐月天台打电话（trust>30+晚上）
- [ ] 追加分支：对穆宁雪态度影响初始关系

#### 第三章·雪峰山（已有：采集/猎杀任务/独眼神狼事件）
- [ ] 审查现有雪峰山任务，串联成实践课剧情
- [ ] 追加伏笔：妖魔异常不是自然现象（唐月/斩空对话暗示）
- [ ] 追加隐藏：山洞古代遗迹（探索触发）
- [ ] 追加分支：受伤妖魔（救/杀选择，影响后续遭遇）
- [ ] 罗宋冲突对话
- [ ] Boss战前后剧情
...
- [ ] 追加隐藏：废弃仓库仪式痕迹（探索触发）
- [ ] 追加隐藏：穆白的笔记（切磋胜利后）
- [ ] 追加分支：与宇昂冲突方式（正面/暗中调查）
- [ ] 追加信息碎片：黑教廷组织结构

#### 第五章·博城灾难（已有：大事件基础数据/多阶段战斗）
- [ ] 审查big-events.js博城灾难数据
- [ ] 追加分支：救援选择（同学/市民/追击黑教廷）
- [ ] 追加分支：是否追击宇昂
- [ ] 追加：唐月展现真实实力剧情
- [ ] 追加：斩空深不可测的暗示
- [ ] 追加隐藏：特殊幸存者
...
#### 第六章·地圣泉（已有：地圣泉任务/灵种系统）
- [ ] 串联地圣泉修炼剧情
- [ ] 追加：小泥鳅坠反应（吸收泉力，物品描述变化）
- [ ] 追加隐藏：泉底古老符文
- [ ] 追加伏笔：地圣泉与古老王陵墓
- [ ] 灵种获得剧情化
