...
**设计理念：** 小说里觉醒系别是随机的，用魔石引导只增加概率不保证；天生天赋也是随机的，极少数人有神赋。游戏需要还原这种随机性，同时保证玩家体验不会太差。
...
**2. 神赋系统（mythic稀有度）**
- [ ] 新增第6种稀有度：mythic（神赋），权重0.3%（约1/333概率）
- [ ] 神赋效果是改变玩法级别的，不只是数值：
  - 天生双系：觉醒时额外获得一个随机系（莫凡同款，但概率极低）
  - 元素共鸣：两系技能可同时释放（不消耗额外回合）
  - 无限星海：MP上限+50%，MP消耗-30%
  - 星语者：技能引导速度翻倍，可打断概率大幅降低
  - 天生灵体：修炼速度+100%，所有经验获取+50%
  - 元素之心：对应系伤害+100%，但受到克制伤害+50%
- [ ] 神赋在UI中有特殊视觉效果（金色/彩虹边框）
- [ ] 神赋不可通过后天获得，只能觉醒时随机出
...
**5. 天赋UI完善**
- [ ] 角色面板天赋详情：显示效果数值、升级进度、触发条件
- [ ] 天赋获得时弹窗："你觉醒了XX天赋！"带稀有度颜色
- [ ] 神赋获得特殊弹窗和成就
